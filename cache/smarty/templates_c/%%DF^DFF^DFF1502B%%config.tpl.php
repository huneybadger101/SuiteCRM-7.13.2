<?php /* Smarty version 2.6.33, created on 2023-05-08 03:12:31
         compiled from modules/EmailMan/tpls/config.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/EmailMan/tpls/config.tpl', 43, false),array('function', 'log', 'modules/EmailMan/tpls/config.tpl', 473, false),)), $this); ?>
<!--
/**
 *
...
>
										...
										<tr class="legacy-compose-option" <?php if (isset ( $this->_tpl_vars['legacyEmailConfigEnabled'] )): ?>style="display:none"<?php endif; ?>>
											<td width="20%" scope="row">
...
:&nbsp;
                        ...
                        <tr>
							<td width="20%" scope="row" valign='top'>
								<?php echo $this->_tpl_vars['MOD']['LBL_LEGACY_EMAIL_COMPOSE_BEHAVIOR']; ?>
:&nbsp;
							</td>
							<td width="30%"  valign='top'>
								<input id="legacy_email_behaviour" name='legacy_email_behaviour' value="true" tabindex='1' class="checkbox" type="checkbox" <?php if (! empty ( $this->_tpl_vars['legacyEmailConfigEnabled'] )): ?>checked="checked<?php endif; ?>">
							</td>
